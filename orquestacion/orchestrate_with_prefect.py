...
def main_flow():
    text_processing_task(
        language = LANGUAGE, 
        path_data_raw = PATH_DATA_RAW, 
        path_data_processed = DATA_PATH_PROCESSED, 
        file_name = FILE_NAME_DATA_INPUT, 
        version = VERSION)
